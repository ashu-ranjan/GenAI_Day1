...
An intelligent **AI-powered code review system** for Python code analysis and improvement suggestions. Built with FastAPI and OpenAI's advanced language models, featuring multi-round review conversations and comprehensive code analysis.
...
### Prerequisites
- Python 3.8+
- OpenAI API key ([Get one here](https://console.OpenAI.com))
...
- **Fast Inference**: Uses OpenAI's optimized models
...
| `OpenAI_MODEL` | No | `llama-3.3-70b-versatile` | Model to use |
...
- **Ashutosh Ranjan** for project development and vision
