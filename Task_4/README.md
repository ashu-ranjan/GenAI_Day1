...
A production-ready customer support chatbot demonstrating three distinct prompt engineering patterns using OpenAI for fast, reliable inference.
...
**Built with ❤️ by Ashutosh Ranjan using FastAPI, Groq AI, and modern web technologies**